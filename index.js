...
function initializeGame() {
    let test1 = document.getElementById("player1")
    let test2 = document.getElementById("player2")
    ...
    if(test1.value != '' && test2.value != ''){ 
        ...
        document.querySelector('h2').innerHTML = 'Jogador da vez: <span id="turnPlayer"></span>'
        updateTitle()
